...
public class ASimpleAppUsingARActivity extends Activity {
    ...
    public void launchFlatBack() {
        Intent intent = new Intent(ASimpleAppUsingARActivity.this, com.example.l33534.google.Location.class);
    ...
    final SensorEventListener sensorEventListener = new SensorEventListener() {
        public void onSensorChanged(SensorEvent sensorEvent) {
            if (sensorEvent.sensor.getType() == Sensor.TYPE_ORIENTATION)
            {
                ...
                Log.e(TAG, "Heading: " + String.valueOf(headingAngle));
                Log.e(TAG, "Pitch: " + String.valueOf(pitchAngle));
                Log.e(TAG, "Roll: " + String.valueOf(rollAngle));
